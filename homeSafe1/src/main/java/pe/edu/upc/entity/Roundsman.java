...
public class Roundsman {
	...
	private boolean State_Roundsman;
	...
	public Roundsman(int iD_Roundsman, int dNI_Roundsman, String firstName_Roundsman, String lastName_Roundsman,
			String address_Roundsman, int cellphone_Roundsman, String sex_Roundsman, Date dateBirth_Roundsman,
			String notes_Roundsman, boolean state_Roundsman) {
		super();
		...
		State_Roundsman = state_Roundsman;
	}
	...
	public boolean isState_Roundsman() {
		return State_Roundsman;
	}

	public void setState_Roundsman(boolean state_Roundsman) {
		State_Roundsman = state_Roundsman;
	}
