...
public class Owner {
	...
	public Owner(int iD_Owner, int iD_BankAccount, int iD_Card, int dNI_Owner, String firstName_Owner,
			String lastName_Owner, String address_Owner, int cellphone_Owner, String country_Owner, int rUC_Owner,
	...
	public int getRUC_Owner() {
		return RUC_Owner;
	}

	public void setRUC_Owner(int rUC_Owner) {
		RUC_Owner = rUC_Owner;
	}
